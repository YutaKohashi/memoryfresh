...
public class MyService07 extends Service {
    ...
    public void onCreate(){
        super.onCreate();
        Log.d("Debug TEST_service7", "onCreate");
//        mNM = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
//        showNotification();
    }
//    private void showNotification() {
//        Log.d("Debug TEST", "showNotification7");
//
...
//        }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("Debug TEST_service7", "onDestroy");
//        mNM.cancel(1);
    }
