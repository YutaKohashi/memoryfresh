...
public class MyService08 extends Service {
    ...
    public void onCreate(){
        super.onCreate();
        Log.d("Debug TEST_service8", "onCreate");
//        mNM = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
//        showNotification();
    }
//    private void showNotification() {
//        Log.d("Debug TEST", "showNotification8");
//
...
//        }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("Debug TEST_service8", "onDestroy");
//        mNM.cancel(1);
    }
